...
static __inline ULONG ReadPixelArray( BASE_PAR_DECL APTR  destRect, UWORD  destX, UWORD  destY, UWORD  destMod, struct RastPort *  RastPort, UWORD  SrcX, UWORD  SrcY, UWORD  SizeX, UWORD  SizeY, UBYTE  DestFormat )
{
        ...
        : "=r" (_res), "+r" (a0), "+r" (d1), "+r" (a1)
        : "r" (a6), "r" (d0), "r" (d2), "r" (d3), "r" (d4), "r" (d5), "r" (d6), "r" (d7)
        : "cc", "memory");
        return _res;
}
...
static __inline ULONG WriteLUTPixelArray( BASE_PAR_DECL APTR  srcRect, UWORD  SrcX, UWORD  SrcY, UWORD  SrcMod, struct RastPort *  RastPort, APTR  CTable, UWORD  DestX, UWORD  DestY, UWORD  SizeX, UWORD  SizeY, UBYTE  CTFormat )
{
        BASE_EXT_DECL
        register unsigned long _res __asm("d0");
        register void *a6 __asm("a6");
        ...
        : "=r" (_res), "+r" (a0), "+r" (d1), "+r" (a1)
        : "r" (a6), "r" (d0), "r" (d2), "r" (a2), "r" (d3), "r" (d4), "r" (d5), "r" (d6), "r" (d7)
        : "cc", "memory");
        return _res;
}
